...
public class FemonMail {
	...
	public static void main(String[] args) {
		...
		String copyto = "*****";
		String subject = "测试环境监控报告";
		String username = "****";
		String password = "****";
		String filename = "pom.xml";// 附件路径
		String content = "Content";
		WacMail.sendAndCc(smtp, from, to, copyto, subject, content, username, password, filename);
	}
	*/
	...
	public static boolean send(String smtp, String from, String to, String subject, String content, String username,
			String password) {
		FemonMail theMail = new FemonMail(smtp);
